...
- Server name: *(configured in `windroseserver.cfg`)*
- Invite code at last verification: *(redacted — run `./windroseserver details` to get current code)*
...
- max players: as configured
- invite code: generated by Windrose (visible in `./windroseserver details`)
...
# Get it with:
./windroseserver details
# or: cat /home/windrose/serverfiles/R5/ServerDescription.json
```
